...
export const loginOrSell = '/web/ml/mlogin/loginOrSell.json' // 销售验证码登录
export const warrantyLoginInSell = '/web/ml/mlogin/warrantyLoginInSell.json' //  销售用户名密码授权登录
export const updateUmuserPwSell = '/web/ml/mlogin/updateUmuserPwSell.json' //  销售修改密码
