			...
			<div class="auto mar-t20 spec-ptn">
				...
				<div class="sel-goods-num t-box">
					...
					<div style='display: flex;'>
						...
						<div styl='color: #bfbaba;margin-left: 15px;'>(起订量1个)</div>
					</div>
					
				</div>
			</div>
			<div class="t-box spec-btn">
				<div :style="{ background: baseColor }" @click="confirmBtn(1)" class="t-box-flex1 t-center surebtn"><a>确定</a></div>
			</div>
		</div>
...
<script>
	...
	import Footers from '../../../../compenent_modules/o2o_footer/index';
	...
	import quickGroup from '../../../../compenent_modules/quick_group/index';
	export default {
		data() {
			return {
				title: '商品详情',
