...
export default {
  ...
  onShow() {
    ...
    http.get(queryContractPageForService, params).then(res => {
      console.log(res, "res");
      if (res && res.rows) {
  ...
  methods: {
    ...
    orderDetail(order) {
      ...
      //     $router.push(v.menuJspath, params);
      //     console.log("1233221")
      $router.push("o2o/pages/order_modules/o2o_order/inforGroup", params);
      //   }
      // });
    },
    toSearch() {
