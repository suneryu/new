             ...
             <div class="order-msg" @click="orderDetail(order)">
                ...
                <div>
                  ...
                  <div style="text-align:right;">
                    <p style="width:160rpx;">{{unitPrice.obpay}}{{order.pricesetNprice}}{{unitPrice.mapay}}</p>
              ...
              <div class="order-btn">
                <div>实付: <i :style="{color:'#d66377'}">{{unitPrice.obpay}}{{order.contractGoodsMoney}}{{unitPrice.mapay}}</i></div>
             </div>
           </a>
         </li>
       </ol>
