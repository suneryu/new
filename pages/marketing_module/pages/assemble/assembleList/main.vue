    ...
    <div class="goods_list" v-if="productList.length > 0">
      ...
      >
        ...
        <div class="product_t">
          ...
          <div class="t_subtitle">已拼{{item.goodsSalesvolume}}件</div>
          <!-- <div class="t_subtitle" v-if="item.goodsProperty3 != 0">{{item.goodsProperty3}}</div> -->
          <div class="f_titlebox">
            <p
              class="f_title"
              v-if="item.goodsProperty3 != 0 &&item.goodsProperty3 != null && item.goodsProperty3 != ''"
              :style="{color:baseColor,borderColor:baseColor}"
            >{{item.goodsProperty3}}人团</p>
          </div>
