		...
		selectNavItem(index, pagePath) {
			...
			switch (pagePath.menuCode) {
				...
				case '00000043':
					...
					break;
				case 'GMP00004':
					this.$router.replace(pagePath.menuJspath);
					break;
				case '00000184':
					this.$router.replace(pagePath.menuJspath);
					break;
						...
						wx.getSetting({
							success: function(res) {
								...
								if (!res.authSetting['scope.userInfo']) {
									that.$router.replace('authorization');
								} else {
									that.$router.replace(pagePath.menuJspath);
								}
							},
							fail: function(res) {
				...
				case 'MP000007':
					...
					this.$router.replace('o2o/pages/classify_modules/o2o_classify'); //o2o分类页
					break;
				case 'MP000010':
					this.$router.replace('o2o/pages/o2o_ShoppingCart');
					break;
				case 'MP000200':
					this.$router.replace('web', {
