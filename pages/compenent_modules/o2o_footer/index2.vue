		...
		<div class="footer t-box">
			<div class="left-cont t-box-flex3">
				<div class="t-box mar-t6">
					...
					<div class="t-box-flex1 text-center font-12 " @click="collectGoods()" v-if="userinfoType == '2'">
			...
			<div class="addcar t-box-flex3" v-if="userinfoType == '2'">
				<div class="addCart" @click="addCart">加入购物车</div>
			</div>
			<div class="addcar t-box-flex3" v-if="userinfoType == '2'">
				<div class="toBuy" @click="goBuy">立即购买</div>
			</div>
			<div class='noBut' v-if="userinfoType == '1'"><span>请先完成企业认证</span></div>
		</div>
		<!--过渡层-->
